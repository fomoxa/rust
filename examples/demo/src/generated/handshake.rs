...
/// everything.
pub const FOMOXA_SCHEMA_FINGERPRINT: u64 = 0xBD60379718901AA5;
...
pub const FOMOXA_MESSAGES: &[FomoxaMessage] = &[
    FomoxaMessage { id: VECTOR3_INPUT_MESSAGE_ID, name: "Vector3.input", fingerprint: VECTOR3_INPUT_FINGERPRINT, prefixes: VECTOR3_INPUT_PREFIXES },
    FomoxaMessage { id: PLAYER_INPUT_INPUT_MESSAGE_ID, name: "PlayerInput.input", fingerprint: PLAYER_INPUT_INPUT_FINGERPRINT, prefixes: PLAYER_INPUT_INPUT_PREFIXES },
    FomoxaMessage { id: VECTOR3_STATE_MESSAGE_ID, name: "Vector3.state", fingerprint: VECTOR3_STATE_FINGERPRINT, prefixes: VECTOR3_STATE_PREFIXES },
    FomoxaMessage { id: GAME_MESSAGE_STATE_MESSAGE_ID, name: "GameMessage.state", fingerprint: GAME_MESSAGE_STATE_FINGERPRINT, prefixes: GAME_MESSAGE_STATE_PREFIXES },
];
